...
aws sts assume-role --role-arn arn:aws:iam::635867519280:role/admin-role --role-session-name admin-session
aws sts assume-role --role-arn arn:aws:iam::635867519280:role/read-role --role-session-name read-session
